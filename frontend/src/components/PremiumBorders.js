...
const OVERLAY_BACKGROUND_VIDEOS = [
  { id: "overlay-drive-1dp9", src: "/overlay-1dp9.mp4" },
  { id: "overlay-drive-1nCx", src: "/overlay-1nCx.mp4" },
  { id: "overlay-drive-1slx", src: "/overlay-1slx.mp4" },
  { id: "overlay-drive-1836", src: "/overlay-1836.mp4" },
  { id: "overlay-drive-1Hb1", src: "/overlay-1Hb1.mp4" },
  { id: "overlay-drive-15yJ", src: "/overlay-15yJ.mp4" },
];
...
export const PremiumBorders = () => {
  ...
  useEffect(() => {
    ...
    setActiveOverlayVideoId(initialQueue[0]);
  }, []);
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-[0] overflow-hidden" data-3d-decor data-animated-bg>
      ...
      <video
        ...
        onEnded={advanceOverlayVideo}
        onError={advanceOverlayVideo}
      />
